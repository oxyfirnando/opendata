...
class Detailikm extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array(//'ID_IKM, 
				'ID_KBLI, ID_KELURAHAN, NAMA_PERUSAHAAN, PIMPINAN, ALAMAT, TELP, JENIS_PRODUK, TENAGA_KERJA_P, TENAGA_KERJA_W, NILAI_INVESTASI, NILAI_PRODUKSI, NILAI_BAHAN_BAKU', 'required'),
