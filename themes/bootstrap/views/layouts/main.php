...
<body>
	...
	<footer class="footer">
		<div class="container">
			<p>Copyright &copy; <?php echo date('Y'); ?> by  Dinas Industri Kecil Dan Menengah (IKM) Kota Padang.<br/>
			All Rights Reserved.<br/>
			Developep By <a href='http://www.oxyfirnando.id' target='_blank'>Programmer House</a> 
